...
// Template data (same as in TemplateSelectionPage)
const templates = [
  {
    id: 'minimal',
    name: 'Minimal',
...
const CustomizePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (selectedTemplate) {
      ...
      // Redirect to template selection if template not found
      navigate('/templates');
    }
  }, [templateId, navigate]);
  ...
  const handleSave = () => {
    ...
    // For now, we'll just navigate to the preview page with the data
  ...
  const handlePreview = () => {
    // Save temporarily and navigate to preview
